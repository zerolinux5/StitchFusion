...
# trainId to label object
trainId2labelText   = { label.trainId : label.name for label in labels }
...
train_classes = list({label.name for label in labels if label.trainId not in [255, -1] })
train_pallet = [name2label[name].color for name in train_classes]
